...
function translate(query) {
    ...
    const baseUrl = ensureHttpsAndNoTrailingSlash(apiUrl || "https://api.moonshot.cn");
                ...
                streamHandler: (streamData) => {
                    if (streamData.text?.includes("Invalid token")) {
                        handleGeneralError(query, {
                            ...
                            troubleshootingLink: "https://platform.moonshot.cn/docs/intro#%E4%BD%BF%E7%94%A8%E6%8C%87%E5%8D%97"
                        });
