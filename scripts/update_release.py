...
def update_appcast(version, desc):
    ...
    version_info = {
        ...
        'desc': desc,
        'sha256': file_hash,
        'url': f'https://github.com/lhui/bob-plugin-moonshot/releases/download/v{version}/{release_file.name}',
        'minBobVersion': '1.8.0'
    }
    ...
    if appcast_file.is_file():
        ...
        appcast = dict(identifier='net.lihui.app.bob.moonshot', versions=[])
